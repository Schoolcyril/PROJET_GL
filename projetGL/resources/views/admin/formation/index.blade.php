                            ...
                            <table class="table">
                                ...
                                @foreach($formations as $item)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ url('/admin/formation/' . $item->id) }}" title="View Formation"><button class="btn btn-info btn-sm"><i class="fa fa-eye" aria-hidden="true"></i> View</button></a>
                                            <a href="{{ url('/admin/formation/' . $item->id . '/edit') }}" title="View Formation"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button></a>
